...
수록 (한국사 1,693문항 · 선사~현대 10개 편 완성):
- 제1편 선사 시대 — 100문항
- 제2편 고조선·초기 국가 — 95문항
- 제3편 삼국·가야 — 157문항
- 제4편 남북국(통일신라·발해) — 101문항
- 제5편 고려 — 288문항
- 제6편 조선 전기 — 187문항
- 제7편 조선 후기 — 182문항
- 제8편 개항기·근대 — 214문항
...
한국사능력검정시험 **제64회~제78회(심화) 각 50문항 전체**가 시대별로 반영되어 있다. 기출에서 나온 문항에는 `한능검 제64회`~`한능검 제78회` 출처 뱃지가 붙고, 같은 논점이 여러 회차에 나오면 **"N회 출제" 빈출 뱃지**가 함께 표시된다.
