...
수록 (한국사 968문항 · 선사~현대 10개 편 완성):
- 제1편 선사 시대 — 90문항
- 제2편 고조선·초기 국가 — 83문항
- 제3편 삼국·가야 — 89문항
- 제4편 남북국(통일신라·발해) — 51문항
- 제5편 고려 — 157문항
- 제6편 조선 전기 — 109문항
- 제7편 조선 후기 — 108문항
- 제8편 개항기·근대 — 121문항
...
한국사능력검정시험 **제78회(심화) 50문항 전체**가 시대별로 반영되어 있으며, 기출에서 나온 문항에는 `한능검 제78회` 출처 뱃지가 붙는다.

한국사능력검정시험 **제78회(심화)** 기출에서 나온 문항에는 `한능검 제78회` 출처 뱃지가 붙는다. (지방세기본법 제1장은 데이터 포맷 참고용 견본으로 함께 둠)
